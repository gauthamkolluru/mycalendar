...
- Each day holds up to **24 notes**. Each note is up to **1000 characters**. Those are app limits so a day still reads like paper; they are not Netlify free-plan quotas.
